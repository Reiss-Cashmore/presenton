  ...
  return (
    <div className="h-full flex flex-col mt-10">
      ...
      <div className="flex-1 overflow-y-auto p-6 pt-0 custom_scrollbar">
                ...
                >
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className="w-full h-12 px-4 py-4 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-colors hover:border-gray-400 justify-between"
                    >
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-4 py-2.5 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-colors"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <textarea
                            ...
                            className="w-full px-4 py-2.5 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-colors font-mono text-xs"
                            rows={6}
        ...
        {/* Model Information */}
        <div className="mb-8 p-4 bg-blue-600/5 rounded-lg border border-blue-600/10">
