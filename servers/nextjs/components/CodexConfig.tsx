  ...
  if (authStatus === "polling") {
    return (
      <div className="space-y-6">
        <div className="flex flex-col items-center gap-4 py-8 px-4 bg-blue-600/5 rounded-xl border border-blue-600/10">
        ...
        <div className="space-y-3">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-colors text-sm"
            value={manualCode}
