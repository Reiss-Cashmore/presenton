          ...
          <div className="relative  w-[275px] ">
            <div className="flex flex-col justify-start gap-2">
              ...
              <input
                ...
                className="w-full px-2 py-3 outline-none border  border-gray-300 rounded-lg focus:ring-2 focus:ring-evri-blue/20 focus:border-evri-blue transition-colors"
            ...
            {(!modelsChecked || (modelsChecked && availableModels.length === 0)) && (
              ...
              <button
                ...
                className={` mt-7 py-2.5 bg-[#F7F6F9] px-3.5 rounded-[48px] text-xs font-semibold text-[#101323] transition-all duration-200 border ${modelsLoading || !openaiApiKey
                  ...
                  : " border-[#EDEEEF] text-evri-blue hover:bg-evri-blue/5 focus:ring-2 focus:ring-evri-blue/20"
                  }`}
              >
                {modelsLoading ? (
