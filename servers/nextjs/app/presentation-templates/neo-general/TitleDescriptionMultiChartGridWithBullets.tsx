...
const MultiChartGridWithBulletsSlideLayout: React.FC<MultiChartGridWithBulletsSlideLayoutProps> = ({ data: slideData }) => {
    ...
    return (
        <>
            ...
            />
            <div
                className="w-full rounded-sm max-w-[1280px] shadow-lg max-h-[720px] aspect-video bg-gradient-to-br from-slate-50 via-white to-blue-600/5 relative z-20 mx-auto overflow-hidden"
                style={{
