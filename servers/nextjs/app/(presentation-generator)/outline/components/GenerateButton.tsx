...
const GenerateButton: React.FC<GenerateButtonProps> = ({
  ...
  return (
    <Button
      ...
      className=" w-full flex items-center gap-0.5 rounded-[58px] text-sm py-3 px-5 font-poppins font-semibold  text-[#101323] disabled:opacity-50 disabled:cursor-not-allowed"
      style={{
