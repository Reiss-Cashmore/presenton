        ...
        <div className="space-y-6 font-poppins">
            {isLoading && (!outlines || outlines.length === 0) && (
                <div className="flex items-center justify-center">
                    <span className="inline-flex items-center gap-1 rounded-full border border-blue-600/20 bg-blue-600/5 text-blue-600 px-2 py-0.5 text-xs">
            ...
            {outlines && outlines.length > 0 && (
                <div>
                    ...
                    <Button
                        ...
                        className="w-full my-4 text-blue-600 border-blue-600/20"
                    >
                        + Add Slide
                    </Button>
                </div>
