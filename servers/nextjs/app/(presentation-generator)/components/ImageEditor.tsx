        ...
        >
          ...
          <div className="mt-6">
            <Tabs defaultValue="generate" className="w-full" onValueChange={handleTabChange}>
              <TabsList className="grid bg-blue-600/10 border border-blue-600/30 w-full grid-cols-3 mx-auto">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {isGenerating || !previewImages ? (
                      ...
                      <div
                        ...
                        className="aspect-[4/3] w-full overflow-hidden rounded-lg border cursor-pointer hover:border-blue-600 transition-colors"
                      >
                        {previewImages && (
                          <img
                            src={previewImages}
                  ...
                  <div
                    className={cn(
                      ...
                      isUploading
                        ...
                        : "border-gray-300 hover:border-blue-600/40"
                    )}
                  >
                    <input
                      type="file"
                    ...
                    {isFocusPointMode && (
                      <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                        <div className="text-white text-center p-2 bg-black/50 rounded">
                          ...
                          <button
                            className="mt-2 px-3 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-600/80"
                            onClick={(e) => {
                              e.stopPropagation();
                    ...
                    <div>
                      ...
                      <div className="flex gap-4">
                        ...
                        <Button
                          variant="outline"
                          className={cn(
                            objectFit === "fill" && "bg-blue-600/5 border-blue-600"
                          )}
