...
const SlideCountSelect: React.FC<{
    ...
    return (
        <Select value={value || ""} onValueChange={onValueChange} name="slides">
            <SelectTrigger
                className="w-[140px]  font-poppins font-medium bg-white text-slate-700 hover:bg-slate-50 focus-visible:ring-evri-blue/30 flex items-center gap-2 h-10 rounded-xl px-3 ring-1 ring-inset ring-slate-200 shadow-sm"
    ...
    <Popover open={open} onOpenChange={onOpenChange}>
        <PopoverTrigger asChild>
            <Button
                ...
                aria-expanded={open}
                className="w-[180px] flex justify-between items-center gap-2 font-poppins font-semibold overflow-hidden bg-white text-slate-700   h-10 rounded-xl px-3 ring-1 ring-inset ring-slate-200 shadow-sm"
            >
        ...
        <div className="flex flex-wrap order-1 gap-4 items-center">
            ...
            <ToolTip content="Advanced settings">
                ...
                <button
                    ...
                    className="ml-auto flex items-center gap-2 text-sm bg-white text-slate-700 hover:bg-slate-50 focus-visible:ring-evri-blue/30 h-10 rounded-xl px-3 ring-1 ring-inset ring-slate-200 shadow-sm font-poppins font-medium"
                ...
                <DialogContent className="max-w-2xl font-poppins">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div className="w-full flex flex-col gap-2">
                            ...
                            >
                                <SelectTrigger className="w-full font-poppins capitalize font-medium bg-white border-slate-300 hover:bg-slate-50 focus-visible:ring-slate-300">
