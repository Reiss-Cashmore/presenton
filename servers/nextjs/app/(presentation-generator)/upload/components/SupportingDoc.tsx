...
const SupportingDoc = ({
    ...
    return (
        <div className="space-y-2" data-testid="attachments-uploader">
            ...
            <label
                className={`mt-1 block cursor-pointer rounded-lg border-2 border-dashed px-4 py-6 text-center transition-colors ${isDragging ? 'border-evri-blue bg-evri-blue/5' : 'border-gray-200 hover:border-evri-blue'}`}
            ...
            >
                ...
                <div className="flex flex-col items-center gap-2">
                    <Paperclip className="h-6 w-6 text-evri-blue" />
                    <p className="text-sm font-medium text-gray-800">
                        Drag and drop PDF, TXT, PPTX, DOCX, or <span className="text-evri-blue">click to browse</span>
                    </p>
                </div>
            </label>
