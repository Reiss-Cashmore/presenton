    ...
    <Wrapper className="pb-10 lg:max-w-[70%] xl:max-w-[65%]">
      ...
      <div className="rounded-2xl border border-slate-200/70 bg-white/80 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/60" >
        <div className="flex flex-col gap-4 md:items-center md:flex-row justify-between p-4">
          <div >
            <h2 className="text-lg font-poppins tracking-tight text-slate-900">Configuration</h2>
        ...
        <div className="p-4 md:p-6">
          <h3 className="text-base font-normal font-poppins text-slate-900 mb-2">Content</h3>
        ...
        <div className="border-t border-slate-200/70" />
        <div className="p-4 md:p-6">
          <h3 className="text-base font-normal font-poppins text-slate-900 mb-2">Attachments (optional)</h3>
        ...
        <div className="p-4 md:p-6">
          <Button
            ...
            className="w-full rounded-[28px] flex items-center justify-center py-5 bg-[#5141e5] text-white font-poppins font-semibold text-lg hover:bg-[#5141e5]/85 focus-visible:ring-2 focus-visible:ring-[#5141e5]/40"
