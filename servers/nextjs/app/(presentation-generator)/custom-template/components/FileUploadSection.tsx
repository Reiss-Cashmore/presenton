    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        {!selectedFile ? (
          ...
          <div className="flex items-center justify-between p-4 bg-blue-600/5 border border-blue-600/20 rounded-lg">
        ...
        <div className="flex flex-col gap-1 ">
          <Button
            ...
            className="flex-1 bg-blue-600 hover:bg-blue-600/80 text-white"
          >
            {isProcessingPptx
              ? "Extracting Slides..."
              : !selectedFile
