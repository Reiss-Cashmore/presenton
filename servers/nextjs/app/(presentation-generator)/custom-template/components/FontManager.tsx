    ...
    <Card className="my-6">
      ...
      <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        className="text-xs bg-blue-600 text-white hover:text-white hover:bg-blue-600/80 border-blue-600"
                      >
        ...
        <Button
          ...
          className="text-xs px-8 py-2 font-semibold bg-blue-600 text-white hover:text-white hover:bg-blue-600/80 border-blue-600"
          >
            Extract Template
        </Button>
          </div>
